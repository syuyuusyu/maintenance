...
function alarmRuleGirde(entity){
//	action "dosomething"
//	alarmLevel 1
//	id 1
//	relevantGroup 54
...
//	valveValue "0.9"
    var store=Ext.create('Ext.data.Store',{
    	fields:['id','roleId','relevantGroup','relevantRecord',
    	        'type','valveValue','alarmLevel','action','groupName','recordName','roleName'],
        proxy : {
            type : 'ajax',
            url : './../entityConf/grid',
            extraParams:entity,
    ...
    var grid=Ext.create('Ext.grid.Panel',{
        ...
        ,columns:[
                 ...
                 {dataIndex:'valveValue',text:'阀值',width:200},
                 {dataIndex:'alarmLevel',text:'等级',width:50},
                 {dataIndex:'action',text:'动作',width:200}
